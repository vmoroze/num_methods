...
int main(void){
    ...
    for(k = 3; k < 7; k++){
        ...
        div(b, temp, r0, n);
        t1t[(k-3)*3 + 0] = M(A, II, JJ, b, c, c0, r, r0, p, p0, temp, n, eps, rr);
        mult(A, II, JJ, c, temp, n);
        t1d[(k-3)*3 + 0] = sqrt((126*d1*d1 + 74*d1*d2 + 22*d2*d2 + 129*d1*d3 + 49*d2*d3 + 37*d3*d3)/60. - 2*scal(b, c, n) + scal(temp, c, n));
        ...
        mult(A, II, JJ, c0, temp, n);
        div(b, temp, r0, n);
        t1t[(k-3)*3 + 1] = M(A, II, JJ, b, c, c0, r, r0, p, p0, temp, n, eps, rr);
        mult(A, II, JJ, c, temp, n);
        t1d[(k-3)*3 + 1] = sqrt(fabs((126*d1*d1 + 74*d1*d2 + 22*d2*d2 + 129*d1*d3 + 49*d2*d3 + 37*d3*d3)/60. - 2*scal(b, c, n) + scal(temp, c, n)));
        ...
        mult(A, II, JJ, c0, temp, n);
        div(b, temp, r0, n);
        t1t[(k-3)*3 + 2] = M(A, II, JJ, b, c, c0, r, r0, p, p0, temp, n, eps, rr);
        mult(A, II, JJ, c, temp, n);
        t1d[(k-3)*3 + 2] = sqrt((126*d1*d1 + 74*d1*d2 + 22*d2*d2 + 129*d1*d3 + 49*d2*d3 + 37*d3*d3)/60. - 2*scal(b, c, n) + scal(temp, c, n));
    }
